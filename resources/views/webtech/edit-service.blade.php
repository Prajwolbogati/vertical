                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                ...
                                <form class="row g-3" method="post" action="{{ url('updateservice') }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="service_name"
                                                placeholder="Enter Your Name" value="{{ $singledata->service_name }}">
                                            @error('service_name')
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputChoosePassword2" class="col-sm-3 col-form-label">Domain
                                            Provider</label>
                                        <div class="col-sm-9">
                                            <select class="form-control" name="stype_id">
                                                <option value="{{ $singledata->parent->stype_id }}">
                                                    {{ $singledata->parent->stype_name }}</option>
