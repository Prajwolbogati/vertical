                                                    ...
                                                    <form class="row g-3" method="post"
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                    name="service_name" placeholder="Enter Your Name">
                                                                @error('service_name')
                                                        ...
                                                        <div class="row mb-3">
                                                            <label for="inputChoosePassword2"
                                                                class="col-sm-3 col-form-label">Domain Provider</label>
                                                            <div class="col-sm-9">
                                                                <select class="form-control" name="stype_id">
                                                                    <option value="">No Subcategory</option>
                                                                    @foreach ($data as $serv)
                                                                        <option value="{{ $serv->stype_id }}">
                                                                            {{ $serv->stype_name }}</option>
                                                                    @endforeach
                                                                </select>
                                                                @error('stype_id')
                                                                    <div class="alert-danger">{{ $message }}</div>
                                            ...
                                            <div class="card-body">
                                                <div class="border p-4 rounded">
                                                    ...
                                                    <form class="row g-3" method="post"
                                                        ...
                                                        <hr />
                                                        <div class="row mb-3">
                                                            <label for="stype_name" class="col-sm-3 col-form-label">Service
                                                                Type Name</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="stype_name"
