                            ...
                            <div class="card border-top border-0 border-4 border-info">
                                <div class="card-body">
                                    <div class="border p-4 rounded">
                                        ...
                                        <hr/>
                                        <div class="row mb-3">
                                            <label for="inputEnterYourName" class="col-sm-3 col-form-label">Client Name</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="inputEnterYourName" placeholder="Enter Your Name">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="inputEmailAddress2" class="col-sm-3 col-form-label">Client Email</label>
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control" id="inputEmailAddress2" placeholder="Email Address">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Client Phone</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="row mb-3">
                                            <label for="inputChoosePassword2" class="col-sm-3 col-form-label">Client Address</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="row mb-3">
                                            <label for="inputAddress4" class="col-sm-3 col-form-label">Client Requirement</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="row mb-3">
                                            <label for="hosting_active_date" class="col-sm-3 col-form-label">Active Date</label>
                                            <div class="col-sm-9">
