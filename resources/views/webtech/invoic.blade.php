                ...
                <table class="table table-striped table-borderless border-0 border-b-2 brc-default-l1">
                    ...
                    @foreach($data as $invoice)
                        <tr id="{{$invoice->service->parent->stype_name}}">
                            ...
                            <td class="text-secondary-d2 amount" id="sexy"value="{{$invoice->amountafterdiscount}}">{{$invoice->amountafterdiscount}}</td>
                        </tr>
                        @endforeach 
                    </tbody>
                </table>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            <div class="row my-2">
                                ...
                                <div class="col-5">
                                    <span class="text-120 text-secondary-d1" id="subtotal"> </span>
                                </div>
                            </div>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-5">
                                    <span class="text-110 text-secondary-d1" id="vat"> </span>
                                </div>
                            </div>
                            ...
                            <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                ...
                                <div class="col-5">
                                    <span class="text-150 text-success-d3 opacity-2" id="vatsubtotal" > </span>
                                </div>
                            </div>
                        </div>
                    </div>
