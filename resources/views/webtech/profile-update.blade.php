  ...
  @section('wrapper')
      ...
      <p><img src="{{ asset('user') }}/{{ Auth::user()->image }}" id="output"
      alt="Admin" class="rounded-circle p-1 bg-primary" height="200px"
      width="200px"></p>
      <input type="file" accept="image/*" name="image" id="file"
      class="form-control" onchange="loadFile(event)"
      style="display: none;">
      <p class="label"><label for="file" style="cursor: pointer;"
      class=" col-form-label">Choose Image</label></p>
      <hr>
  @else
      <p><img src="assets/images/webtechlogo.svg" id="output" alt="Admin"
      class="rounded-circle p-1 bg-primary" height="200px"
      width="200px"></p>
      <input type="file" accept="image/*" name="image" id="file"
      class="form-control" onchange="loadFile(event)"
      style="display: none;">
