...
Route::get('domain-exp-15', [domainController::class, 'domainExp15']);

Route::get('domain-exp-7', [domainController::class, 'domainExp7']);

Route::get('domain-expired', [domainController::class, 'domainExpired']);

Route::get('domain-deleted', [domainController::class, 'domainDeleted']);

Route::get('domain-suspend', [domainController::class, 'domainSuspend']);

Route::get('hosting-exp-15', [hostingController::class, 'hostingExp15']);

Route::get('hosting-exp-7', [hostingController::class, 'hostingExp7']);

Route::get('hosting-expired', [hostingController::class, 'hostingExpired']);

Route::get('hosting-deleted', [hostingController::class, 'hostingDeleted']);

Route::get('hosting-suspend', [hostingController::class, 'hostingSuspend']);
